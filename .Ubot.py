...
async def show_help(event):
    help_text = (
        ...
        "/blacklist - Masukkan grup saat ini ke dalam daftar hitam agar tidak menerima promosi.\n"
        "/addqr - Tambahkan kode QR (kirim gambar sebagai balasan untuk perintah ini).\n"
        "/getqr - Ambil semua kode QR yang tersimpan.\n"
        "/afk <reason> - Tetapkan pesan AFK dengan alasan.\n"
